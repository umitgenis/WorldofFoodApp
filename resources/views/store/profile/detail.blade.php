...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center mt-8">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary opacity-75">My Profile </div>

                    <div class="card-body">
                        <form method="POST" action="{{route('store.profile.update',['id'=>$data['id']])}}">
                            @csrf
        ...
        <div class="row justify-content-center mt-5 mb-8">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{ route('store.profile.update-password') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if (session('status'))
                                <div class="alert alert-success" role="alert">
